...
import 'package:flutter/material.dart' hide InputDecoration, InputDecorator;
import 'package:input_decorator/src/floating_label_alignment.dart';
...
class _HelperErrorState extends State<_HelperError>
  ...
  Widget _buildError() {
    assert(_hasError, 'errorText or error must be provided');

    assert(
        widget.error == null ||
            (widget.errorBuilder == null && widget.errorText == null),
  ...
  const InputDecoration({
    ...
    this.constraints,
        ...
        assert(!(error != null && errorBuilder != null),
            'Declaring both error and errorBuilder is not supported.');
